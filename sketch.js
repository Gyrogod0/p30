...
function draw() {
  ...
  rectMode(CENTER);
  ground.display();
  box1.display("cyan", "black");
  box2.display("cyan", "black");
  box3.display("cyan", "black");
  box4.display("cyan", "black");
  box5.display("cyan", "black");
  box6.display("cyan", "black");
  box7.display("cyan", "black");
  box8.display("cyan", "black");
  box9.display("cyan", "black");
  box10.display("cyan", "black");
  box11.display("cyan", "black");
  box12.display("cyan", "black");
  box13.display("cyan", "black");
  box14.display("cyan", "black");
  box15.display("cyan", "black");
  py1.display("cyan", "black")
  py2.display("cyan", "black")
  py3.display("cyan", "black")
  py4.display("cyan", "black")
  py5.display("cyan", "black")
  py6.display("cyan", "black")
  sling.display("red");
  stand1.display();
  stand2.display();
  ball.display("yellow", "pink");
  textSize(30);
  fill(0);
  text("DRAG AND RELEASE THE BALL TO DESTROY THE BOXES", 250, 385)
  fill("yellow");
  textSize(15);
